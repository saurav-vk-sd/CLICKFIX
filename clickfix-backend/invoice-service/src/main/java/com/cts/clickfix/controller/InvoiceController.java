...
//	}
	...
	public InvoiceDto findInvoiceById(@PathVariable int invoiceId) {
		...
		logger.debug("Invoice found: {}", resObj);
		return resObj;
	}
	...
	public InvoiceDto deleteInvoice(@RequestParam int invoiceId) {
		InvoiceDto deleted = invoiceService.deleteInvoice(invoiceId); 
		logger.debug("Invoice deleted: {}", deleted);
		return deleted;
	}
	...
	public int getInvoiceId(@PathVariable("bookingId") int bookingId) {
		int invoiceId =  invoiceService.getInvoiceId(bookingId);
	...
	@PutMapping("/invoice/completeTransaction/{invoiceId}")
	public void completeTransaction(@PathVariable ("invoiceId") int bookingId) {
		invoiceService.completeTransaction(bookingId);
	}
}
